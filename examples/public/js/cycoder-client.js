...
var Channel = /*#__PURE__*/function () {
  function Channel(socket, name, data) {
  ...
  _createClass(Channel, [{
    ...
    key: "stop",
    value: function stop(event, callback) {
    ...
    value: function send(event) {
      ...
      (_a = this.socket) === null || _a === void 0 ? void 0 : (_a2 = _a).emit.apply(_a2, [event].concat(args));
      return this;
    }
  }, {
    key: "on",
    value: function on(event, callback) {
      ...
      (_a = this.socket) === null || _a === void 0 ? void 0 : _a.on(event, function (channel, data) {
        if (_this.name === channel && data.event === event) {
          delete data.event;
...
var channel_1 = __webpack_require__(/*! ./channel */ "./build/channel.js");
...
/******/ 	return __webpack_require__("./build/index.js");
/******/ })()
;
});
//# sourceMappingURL=cycoder-client.js.map